...
import SoftFeetImage from '../../../assets/Soft_Feet.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Soft feet</strong> is a tier 2 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. It decreases the noise the player makes while passing through vegetation.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reduces the noise generated when moving through foliage such as grass and leaves.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reduces the noise generated when moving through larger vegetation such as bushes and shrubs.
                        </div>
                    </div>
                </div>
            </div>
