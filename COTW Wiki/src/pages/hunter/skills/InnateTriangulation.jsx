...
import InnateTriangulationImage from '../../../assets/Innate_Triangulation.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={InnateTriangulationImage} 
                        alt="Innate Triangulation Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Innate Triangulation</strong> is a tier 3 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. It decreases the size of the animal vocalization indicator and thus makes it easier to locate animals via their calls.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Each level decreases the size of the animal vocalization indicator in the world, making it easier to pinpoint the position of the animal that produced the call.
                        </div>
                    </div>
