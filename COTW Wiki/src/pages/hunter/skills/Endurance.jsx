...
import EnduranceImage from '../../../assets/Endurance.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Endurance</strong> is a tier 3 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. It influence the speed of heart rate increase and fall.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans mb-6">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            All that walking has to be good for something, right? Increase your endurance so that your heart rate rises slower when moving and falls faster when idle.
                        </div>
                    </div>
                </div>

                <p className="text-stone-300 text-[16px] leading-relaxed">
                    Endurance allows the maximum heart rate to only be sustained when moving at full speed by foot.
                </p>
            </div>
