...
import WhosDeerImage from '../../../assets/Whos_Deer.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Who's Deer?</strong> is a tier 3 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It increases the features of <a href="/equipment/callers" className="text-green-400 hover:underline">callers</a>.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Adds a random chance of attracting a species that is not usually attracted by a particular caller.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Adds a random chance of inducing a vocalization response from a species that is not usually affected by a particular caller.
                        </div>
                    </div>
                </div>
            </div>
