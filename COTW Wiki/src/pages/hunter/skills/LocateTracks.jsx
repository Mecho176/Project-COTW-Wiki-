...
import LocateTracksImage from '../../../assets/Locate_Tracks.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={LocateTracksImage} 
                        alt="Locate Tracks Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Locate Tracks</strong> is a tier 0 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. Spending skill points in this skill will decrease the width of the tracking cone and will also increase the distance at which <a href="/animals/tracks" className="text-green-400 hover:underline">tracks</a> are visible.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            The directional tracking cone becomes more accurate and narrower, both in the world and on the map.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the distance at which tracks are visible and highlighted.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            The directional tracking cone is now even more narrow and tracks can be detected farther away.
                        </div>
                    </div>
                </div>
            </div>
