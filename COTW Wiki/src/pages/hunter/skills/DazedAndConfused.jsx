...
import DazedAndConfusedImage from '../../../assets/Dazed_and_Confused.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={DazedAndConfusedImage} 
                        alt="Dazed and Confused Icon" 
                        className="w-[117px] h-[130px] object-contain"
                    />
                </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Dazed and Confused</strong> is a tier 1 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It wields the chance that animals are attracted by <a href="#" className="text-green-400 hover:underline">scent lures</a> targeted at other animals.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Adds a random chance of attracting an animal that is not usually attracted by a particular scent.
                        </div>
                    </div>
                </div>
            </div>
