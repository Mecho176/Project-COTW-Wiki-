...
import FatalAttractionImage from '../../../assets/Fatal_Attraction.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={FatalAttractionImage} 
                        alt="Fatal Attraction Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Fatal Attraction</strong> is a tier 2 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It increases the features of <a href="#" className="text-green-400 hover:underline">callers</a>.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increased chance of attracting animals to your location when using callers.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increased chance of eliciting a vocalization response from nearby animals when using callers.
                        </div>
                    </div>
                </div>
            </div>
