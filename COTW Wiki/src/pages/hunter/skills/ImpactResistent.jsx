...
import ImpactResistantImage from '../../../assets/Impact_Resistant.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={ImpactResistantImage} 
                        alt="Impact Resistent Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Impact Resistent</strong> is a tier 2 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It reduces falling damage.
                </p>
            </div>
            ...
            <div className="clear-both">
                ...
                <p className="text-stone-300 italic mb-4 font-sans text-[16px]">
                    Is it a plane? Is it a bird? No, it's a falling hunter!
                </p>
