...
import SightSpottingImage from '../../../assets/Sight_Spotting.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={SightSpottingImage} 
                        alt="Sight Spotting Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Sight Spotting</strong> is a tier 2 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It unlocks the ability to <a href="/animals/spotting" className="text-green-400 hover:underline">spot</a> animals with weapon scopes.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Unlocks the ability to spot animals while in aim mode with weapons. This means that you do not have to switch to <a href="/binoculars" className="text-green-400 hover:underline">binoculars or a rangefinder device</a> to spot an animal.
                        </div>
                    </div>
                </div>
            </div>
