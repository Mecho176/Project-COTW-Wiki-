...
import PackMuleImage from '../../../assets/Pack_Mule.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Pack Mule</strong> is a tier 3 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It increases the weight the player can carry.
                </p>
            </div>
            ...
            <div className="clear-both">
                ...
                <p className="text-stone-300 italic mb-4 font-sans text-[16px]">
                    Clever insights into space management has allowed you to carry more gear.
                </p>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the base carry capacity by 15%. This does not affect <a href="/backpack" className="text-green-400 hover:underline">backpacks</a>.
                        </div>
                    </div>
                </div>
            </div>
