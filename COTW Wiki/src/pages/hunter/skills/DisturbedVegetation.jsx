...
import DisturbedVegetation from '../../../assets/Disturbed_Vegetation_Icon.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={DisturbedVegetation} 
                        alt="Disturbed Vegetation Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Disturbed Vegetation</strong> is a tier 4 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. It adds a new kind of <a href="#" className="text-green-400 hover:underline">track</a> animals can leave behind.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reveals a new track type, disturbed vegetation. Animals sometimes produce these in-between other tracks. This makes it easier to follow trails of difficult animals and reveals the animal's fur type when combined with the <a href="#" className="text-green-400 hover:underline">Track Knowledge</a> skill.
                        </div>
                    </div>
                </div>
            </div>
