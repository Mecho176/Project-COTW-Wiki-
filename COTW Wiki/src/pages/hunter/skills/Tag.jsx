...
import TagImage from '../../../assets/Tag.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Tag</strong> is a tier 3 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It increases the outlining of animals upon <a href="/animals/spotting" className="text-green-400 hover:underline">spotting</a>.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the duration of the traced outline on an animal after spotting it.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Unlocks the ability to add a spotting outline on up to 3 animals simultaneously.
                        </div>
                    </div>
                </div>
            </div>
