...
import TrackKnowledgeImage from '../../../assets/Track_Knowledge.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={TrackKnowledgeImage} 
                        alt="Track Knowledge Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Track Knowledge</strong> is a tier 1 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. It increases the amount of information gained by <a href="/animals/tracks" className="text-green-400 hover:underline">investigation of animal tracks</a>.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reveals information about an animal's gender when investigating footprints and vocalizations.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reveals information about approximate animal group size when investigating need zone tracks and an animal's approximate health when investigating blood trails.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reveals information about an animal's approximate weight when investigating footprints and fur type when investigating disturbed vegetation.
                        </div>
                    </div>
                </div>
            </div>
