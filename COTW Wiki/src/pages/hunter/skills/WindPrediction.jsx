...
import WindPredictionImage from '../../../assets/Wind_Prediction.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={WindPredictionImage} 
                        alt="Wind Prediction Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Wind Prediction</strong> is a tier 4 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. It can be used to approximate changes in wind speed and direction. It also allows the player to move quieter by masking movement noise with the ambient wind noise.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Unlocks the ability to detect when the general wind speed is about to increase by observing how it rolls over the landscape. Ambient wind noise masks your movement noise, allowing you to move more quietly.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Unlocks the ability to approximate the general wind direction and when it will change.
                        </div>
                    </div>
                </div>
            </div>
