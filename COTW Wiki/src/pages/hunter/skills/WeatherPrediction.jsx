...
import WeatherPredictionImage from '../../../assets/Weather_Prediction.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Weather Prediction</strong> is a tier 2 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. It can be activated to predict future weather changes.
                </p>
            </div>
            ...
            <div className="clear-both">
                ...
                <p className="text-stone-300 italic mb-4 font-sans text-[16px]">
                    Extensive studies in the art of meteorology has unlocked the ability to make accurate predictions about local weather conditions.
                </p>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Unlocks the ability to approximate when the weather will change and to what state, for example when it goes from clear to rainy
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Further extends the ability to predict weather changes in the future.
                        </div>
                    </div>
                </div>
            </div>
