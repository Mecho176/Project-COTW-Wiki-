...
import SpottingKnowledgeImage from '../../../assets/Spotting_Knowledge.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={SpottingKnowledgeImage} 
                        alt="Spotting Knowledge Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Spotting Knowledge</strong> is a tier 1 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It increases the amount of information gained via <a href="/animals/spotting" className="text-green-400 hover:underline">spotting</a>.
                </p>
            </div>
            ...
            <div className="clear-both">
                ...
                <p className="text-stone-300 italic mb-4 font-sans text-[16px]">
                    Increases the amount of information that can be gained from the last animal spotted.
                </p>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reveals information about the approximate health of the animal.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reveals information about the approximate trophy rating of the animal.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reveals information about how aware the animal is of nearby threats.
                        </div>
                    </div>
                </div>
            </div>
