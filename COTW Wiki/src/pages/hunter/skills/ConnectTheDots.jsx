...
import ConnectTheDotsImage from '../../../assets/Connect_The_Dots.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={ConnectTheDotsImage} 
                        alt="Connect The Dots Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Connect The Dots</strong> is a tier 2 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the stalker skill tree. It will improve the usability of the <a href="#" className="text-green-400 hover:underline">huntermate</a> by connecting tracks in consecutive order, making it easier to follow tracks where the animal run circles or crossed old tracks of itself.
                </p>
            </div>
            ...
            <div className="clear-both">
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-start hover:bg-stone-700/10">
                        <div className="col-span-2 font-bold text-stone-100 text-center pt-2">1</div>
                        <div className="col-span-10 text-stone-300 space-y-4 italic leading-relaxed">
                            <p>
                                Each time a track is investigated, a trail line is automatically drawn on your Huntermate between tracks of the active trail (the animal you are tracking). Trail direction is also indicated with an arrow.
                            </p>
                            <p>
                                Investigated tracks that were not dropped in consecutive order have a dotted line drawn between them to indicate that there are more tracks to be found to complete the trail. The dotted line will not occur if three tracks in order are skipped.
                            </p>
                        </div>
                    </div>
                </div>
