...
import HaggleImage from '../../../assets/Haggle.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Haggle</strong> is a tier 4 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It reduces the purchasing costs of all items in the shop.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Reduces the cost of all items in the <a href="#" className="text-green-400 hover:underline">outpost store</a> by 5%.
                        </div>
                    </div>
                </div>
            </div>
