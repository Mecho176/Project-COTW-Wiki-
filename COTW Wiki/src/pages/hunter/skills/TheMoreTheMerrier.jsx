...
import TheMoreTheMerrierImage from '../../../assets/The_More_The_Merrier.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={TheMoreTheMerrierImage} 
                        alt="The More The Merrier Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">The More The Merrier</strong> is a tier 1 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It increases the amount of <a href="/cash" className="text-green-400 hover:underline">money</a> gained by completing missions.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the monetary reward gained from completing any mission by 5%.
                        </div>
                    </div>
                </div>
            </div>
