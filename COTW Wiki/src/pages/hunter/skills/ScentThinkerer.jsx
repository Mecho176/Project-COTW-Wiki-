...
import ScentTinkererImage from '../../../assets/Scent_Tinkerer.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={ScentTinkererImage} 
                        alt="Scent Tinkerer Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Scent Tinkerer</strong> is a tier 0 <a href="/skills" className="text-green-400 hover:underline">skill</a> of the ambusher skill tree. It increases the features of <a href="/lures" className="text-green-400 hover:underline">scent lures</a>.
                </p>
            </div>
            ...
            <div className="clear-both">
                ...
                <p className="text-stone-300 italic mb-4 font-sans text-[16px]">
                    Not satisfied with the performance of the scent lures in the store? Become a true scent alchemist!
                </p>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the number of uses per canister for all scent lures purchased.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the duration of all scent lures.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the range of all scent lures.
                        </div>
                    </div>

                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        <div className="col-span-2 font-bold text-stone-100 text-center">4</div>
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the attraction chance of all scent lures.
                        </div>
                    </div>
                </div>
            </div>
