...
import scentImage from '../../assets/Scent.webp';
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed space-y-4">
                <p>
                    <strong className="text-white">Scent</strong> travels with the wind and can alarm animals if they sense it. The player's scent spreads differently depending on the wind's behaviour. If the wind is strong, the scent will be carried far, but narrowly along the wind's direction. If the wind is not strong, the scent will not be carried as far, but will disperse more widely.
                </p>
                <p>
                    Scent can be temporarily masked using a <a href="#" className="text-green-400 hover:underline">scent eliminator</a>.
                </p>
            </div>
