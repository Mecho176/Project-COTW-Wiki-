      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="text-sm">
                    ...
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-green-400 cursor-pointer hover:underline"><a href="/perks/move-n-shoot">Move n' Shoot</a></div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Recycle</strong> is a tier 2 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/bows" className="text-green-400 hover:underline">bows</a>. It unlocks the ability to retrieve fired arrows from shot animals.
                </p>
            </div>
            ...
            <div className="clear-both">
                ...
                <p className="text-stone-300 italic mb-4 font-sans text-[16px]">
                    Unlocks the ability to retrieve fired arrows. There is a random chance that an arrow will break upon impact, in which case it cannot be retrieved.
                </p>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Unlocks the ability to retrieve arrows.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Decreases the chance that an arrow will break upon impact.
                        </div>
                    </div>
                </div>
            </div>
