...
import TraceshotImage from '../../../assets/Tracershot.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="text-sm">
                    ...
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-green-400 cursor-pointer hover:underline"><a href="/perks/fast-shouldering">Fast Shouldering</a></div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Tracershot</strong> is a tier 2 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/shotguns" className="text-green-400 hover:underline">shotguns</a>. It enables shotguns to fire <em className="italic">tracer shots</em> which leave smoke trails behind, making it easier to investigate the pellet spread.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Ability to trigger a tracer shot when firing shotguns. Pellets will leave behind smoke trails indicating the spread of the bullet.
                        </div>
                    </div>
                </div>
            </div>
