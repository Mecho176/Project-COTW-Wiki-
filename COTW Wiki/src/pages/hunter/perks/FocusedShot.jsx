...
import FocusedShotImage from '../../../assets/Focused_Shot.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={FocusedShotImage} 
                        alt="Focused Shot Icon" 
                ...
                <div className="text-sm">
                    ...
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-green-400 cursor-pointer hover:underline">Breath Control</div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Focused Shot</strong> is a tier 3 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/rifles" className="text-green-400 hover:underline">rifles</a>. It increases the zoom while holding breath.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Holding your breath increases zoom when using rifles with iron, red dot and holographic <a href="/weapons/sights" className="text-green-400 hover:underline">sights</a>.
                        </div>
                    </div>
                </div>
            </div>
