...
import BoomstickImage from '../../../assets/Boomstick.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
                ...
                <div className="text-sm">
                    ...
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-green-400 cursor-pointer hover:underline flex flex-col">
                            <span>Tracershot, Recoil Management</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Boomstick</strong> is a tier 3 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/shotguns" className="text-green-400 hover:underline">shotguns</a>. It enables the player to fire both chambers of a double-barreled shotgun at once.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Ability to fire both chambers at the same time when using a double-barreled shotgun.
                        </div>
                    </div>
                </div>
            </div>
