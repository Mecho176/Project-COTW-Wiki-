...
import BodyControlImage from '../../../assets/Body_Control.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={BodyControlImage} 
                        alt="Body Control Icon" 
                ...
                <div className="text-sm">
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-stone-400">Shotgun</div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-green-400 cursor-pointer hover:underline">Both Eyes Open</div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Body Control</strong> is a tier 1 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/shotguns" className="text-green-400 hover:underline">shotguns</a>. It improves weapon alignment after rotation.
                </p>
            </div>
            ...
            <div className="clear-both">
                <div className="flex items-center space-x-2 border-b border-stone-700 pb-2 mb-4">
                    <h2 className="text-2xl font-bold text-stone-100">Level</h2>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Weapon sights align faster after rotating with any weapon. Each level unlocked increases the effect.
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            {/* Empty in screenshot, implying continued effect increase */}
                        </div>
                    </div>
                </div>
            </div>
