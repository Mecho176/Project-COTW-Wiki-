...
import IncreasedConfidenceImage from '../../../assets/Increased_Confidence.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={IncreasedConfidenceImage} 
                        alt="Increased Confidence Icon" 
                ...
                <div className="text-sm">
                    ...
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-green-400 cursor-pointer hover:underline">Move n' Shoot</div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Increased Confidence</strong> is a tier 2 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/bows" className="text-green-400 hover:underline">bows</a>. Increases accuracy of all bows when shooting from the hip.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10 border-b border-stone-700/50">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases accuracy of all bows when shooting from the hip. Each level unlocked increases the effect.
                        </div>
                    </div>
