...
import ZeroingImage from '../../../assets/Zeroing.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="text-sm">
                    ...
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-green-400 cursor-pointer hover:underline flex flex-col">
                            <a href="/perks/breath-control">Breath Control</a>
                            <a href="/perks/steady-hands">Steady Hands</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Zeroing</strong> is a tier 2 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/rifles" className="text-green-400 hover:underline">rifles</a>. It adds additional zero distances.
                </p>
            </div>
            ...
            <div className="clear-both">
                ...
                <p className="text-stone-300 italic mb-4 font-sans text-[16px]">
                    Unlocks the ability to switch between different zero distances, in addition to the default Medium Range Zero, on any weapon that supports it.
                </p>
