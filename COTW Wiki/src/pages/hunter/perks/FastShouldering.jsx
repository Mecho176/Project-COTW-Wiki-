...
import FastShoulderingImage from '../../../assets/Fast_Shouldering.webp';
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-stone-900">
                    <img 
                        src={FastShoulderingImage} 
                        alt="Fast Shouldering Icon" 
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Fast Shouldering</strong> is a tier 1 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/shotguns" className="text-green-400 hover:underline">shotguns</a>. It improves the use of the aim mode.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center border-b border-stone-700/30 hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Increases the speed of entering and exiting aim mode using any weapon. Each level unlocked increases the effect.
                        </div>
                    </div>
