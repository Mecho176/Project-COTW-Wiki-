...
import MoveNShootImage from '../../../assets/Move_n_Shoot.webp';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-[270px] min-h-[324.5px] ml-6 mb-4 bg-stone-800 border border-stone-700 shadow-xl font-sans">
                ...
                <div className="text-sm">
                    ...
                    <div className="grid grid-cols-2 border-t border-stone-700/50">
                        ...
                        <div className="p-2 text-green-400 cursor-pointer hover:underline"><a href="/perks/full-draw">Full Draw</a></div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-stone-300 font-sans text-[16px] leading-relaxed">
                <p>
                    <strong className="text-stone-100">Move n' Shoot</strong> is a tier 1 <a href="/perks" className="text-green-400 hover:underline">perk</a> for <a href="/weapons/bows" className="text-green-400 hover:underline">bows</a>. It decreases aim wobble while moving.
                </p>
            </div>
                ...
                <div className="bg-stone-800 border border-stone-700 text-sm md:text-base font-sans">
                    ...
                    <div className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-stone-700/10">
                        ...
                        <div className="col-span-10 text-stone-300 italic leading-relaxed">
                            Decreased aim wobble while moving in aim mode using any weapon.
                        </div>
                    </div>
                </div>
            </div>
