...
export default function App() {
  ...
  const linkMap = {
    "Connect The Dots": "/skills/connect-the-dots",
    "Dazed and Confused": "/skills/dazed-and-confused",
    "Disturbed Vegetation": "/skills/disturbed-vegetation",
    "Endurance": "/skills/endurance",
    "Fatal Attraction": "/skills/fatal-attraction",
    "Haggle": "/skills/haggle",
    "Hardened": "/skills/hardened",
    "Hill Caller": "/skills/hill-caller",
    "I'm only happy when it rains": "/skills/im-only-happy-when-it-rains",
    "Impact Resistent": "/skills/impact-resistent",
    "Improvised Blind": "/skills/improvised-blind",
    "Innate Triangulation": "/skills/innate-triangulation",
    "Keen Eye": "/skills/keen-eye",
    "Locate Tracks": "/skills/locate-tracks",
    "Pack Mule": "/skills/pack-mule",
    "Scent Tinkerer": "/skills/scent-tinkerer",
    "Sight Spotting": "/skills/sight-spotting",
    "Soft Feet": "/skills/soft-feet",
    "Spotting Knowledge": "/skills/spotting-knowledge",
    "Startle Call": "/skills/startle-call",
    "Tag": "/skills/tag",
    "The More The Merrier": "/skills/the-more-the-merrier",
    "Track Knowledge": "/skills/track-knowledge",
    "Weather Prediction": "/skills/weather-prediction",
    "Who's deer?": "/skills/whos-deer",
    "Wind Prediction": "/skills/wind-prediction"
  };

  const renderSkillLink = (skillName) => {
    const link = linkMap[skillName];
    if (link) {
      return <a href={link} className="text-green-400 hover:underline">{skillName}</a>;
    }
    return <a href="#" className="text-green-400 hover:underline">{skillName}</a>;
  };
                                ...
                                <tr key={row.tier} className="hover:bg-stone-700/10 align-top">
                                    ...
                                    <td className="p-3 space-y-1">
                                        {row.ambusher.map((skill, i) => (
                                            <div key={i}>{renderSkillLink(skill)}</div>
                                        ))}
                                    </td>
                                    <td className="p-3 space-y-1">
