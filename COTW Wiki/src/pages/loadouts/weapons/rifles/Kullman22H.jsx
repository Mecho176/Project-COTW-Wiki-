      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-72 ml-6 mb-4 bg-white border border-gray-200 shadow-xl font-sans">
                ...
                <div className="text-sm bg-white">
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
                        ...
                        <div className="text-green-800">5500</div>
                    </div>
                ...
                <div className="text-sm bg-white">
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2 bg-gray-50">
                        ...
                        <div className="text-green-800">20</div>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
            ...
            <div className="mb-8 text-gray-700 font-sans text-[16px] leading-relaxed">
                ...
                <p className="mt-4">
                    This weapon is available as part of the <a href="#" className="text-green-800 hover:underline">Mississippi Acres Preserve</a> DLC.
                </p>
            </div>
            ...
            <div className="space-y-12 clear-both">
                ...
                <div id="sights">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">The following sights can be equipped on the Kullman .22H:</p>
                ...
                <div id="analysis">
                    ...
                    <div className="text-gray-700 font-sans text-[16px] leading-relaxed space-y-4">
                        <p>
                            This is one of only 2 non-bow and shotgun weapons in the game that are eligible for class 1, but not limited to it (the other being the <a href="#" className="text-green-800 hover:underline">Mangiafico 410/45 Colt</a>). It has excellent characteristics of damage (for its classes), range, accuracy and magazine size. It eliminates the need to switch weapons when hunting birds and, for example, raccoons. Kullman is the rifle with the longest range in class 1 (150 m, when others are limited to 50-100 m).
                        </p>
                        <p>
                ...
                <div id="trivia">
                    ...
                    <ul className="list-disc list-inside text-gray-700 font-sans text-[16px] space-y-2 mb-4">
                        <li>The Kullman .22H is modeled after its real-life counterpart of the Ruger 77/22.</li>
                        <li>The Variant names "Yellow jacket" and "Wasp" are both very ironic as .22H stands for .22 Hornet and while hornets are a type of wasp, Hornets are much different.</li>
                    </ul>
                    <div className="mt-4">
                        <img 
                            src={KullmanGalleryImage} 
                            alt="Kullman .22H Gallery" 
                            style={{ width: '616px', height: '268px' }}
