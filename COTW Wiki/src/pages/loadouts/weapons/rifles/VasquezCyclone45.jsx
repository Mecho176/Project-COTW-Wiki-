        ...
        <div className="block">
            ...
            <div className="float-right w-72 ml-6 mb-4 bg-white border border-gray-200 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-gray-50">
                    <img 
                        src={VasquezCycloneImage} 
                        alt="Vasquez Cyclone .45 Rifle" 
                ...
                <div className="text-sm bg-white">
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
                        ...
                        <div className="text-green-800">7</div>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-12 clear-both">
                ...
                <div id="sights">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">The following sights can be equipped on the Vásquez Cyclone .45:</p>
                ...
                <div id="trivia">
                    ...
                    <p className="text-gray-700 font-sans text-[16px]">
                        The Vásquez Cyclone is modeled after its real-life counterpart of the Hatsan Hercules air rifle chambered in .45 caliber pellets.
                    </p>
                </div>
