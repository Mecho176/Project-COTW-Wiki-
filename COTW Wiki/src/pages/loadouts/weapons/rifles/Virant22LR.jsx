        ...
        <div className="block">
            ...
            <div className="float-right w-72 ml-6 mb-4 bg-white border border-gray-200 shadow-xl font-sans">
                ...
                <div className="flex justify-around bg-gray-100 text-xs text-gray-500 py-1 border-b border-gray-200">
                    <span 
                        className={`cursor-pointer ${selectedVariant === 'Express' ? 'text-green-800 underline decoration-2 underline-offset-4 decoration-blue-600 font-bold' : 'hover:text-green-800'}`}
                        onClick={() => setSelectedVariant('Express')}
                    >
                        Express
                    </span>
                    <span 
                        className={`cursor-pointer ${selectedVariant === 'Klasika' ? 'text-green-800 underline decoration-2 underline-offset-4 decoration-blue-600 font-bold' : 'hover:text-green-800'}`}
                        onClick={() => setSelectedVariant('Klasika')}
                    >
                        Klasika
                    </span>
                </div>
                ...
                <div className="text-sm bg-white">
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2 bg-gray-50">
                        ...
                        <div className="text-green-800">2.5</div>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
            ...
            <blockquote className="mb-6 border-l-4 border-green-800 pl-4 italic text-gray-600 font-sans text-sm">
                <p className="mb-2">"Developed by slovenian gunsmiths for rabbit hunting, the VIRANT is the go to rifle for varmint control and target shooting. The .22LR's low recoil and superb design makes <br />this rifle a perfect starting point for people learning the basics of shooting."</p>
            ...
            <div className="mb-8 text-gray-700 font-sans text-[16px] leading-relaxed space-y-4">
                <p>
                    The <strong className="text-gray-900">Virant .22LR Express</strong> is a small-caliber rifle designed to hunt all species of hare. The rifle's very high accuracy and ability to fire quick consecutive shots make it ideal for hunting small and difficult-to-hit game of class 1.
                </p>
                <p>
                    The Virant .22LR family is available as part of the <a href="#" className="text-green-800 hover:underline">Weapon Pack 1</a> DLC.
                </p>
            </div>
            ...
            <div className="space-y-12 clear-both">
                ...
                <div id="ammo">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">This rifle has two types of ammo available:</p>
                    ...
                    <p className="text-gray-600 mt-2 text-sm">This is the same ammo that <a href="#" className="text-green-800 hover:underline">Andersson</a> and <a href="#" className="text-green-800 hover:underline">Zarza-15</a> use.</p>
                </div>
                ...
                <div id="sights">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">The following sights can be equipped on the Virant .22LR:</p>
                ...
                <div id="variants">
                    ...
                    <div className="text-gray-700 font-sans text-[16px] leading-relaxed space-y-4">
                        <p>
                            The <strong className="text-gray-900">Virant .22LR Klasika</strong> is an available design, featuring a classical wooden rifle look.
                        </p>
                    </div>
                </div>
                ...
                <div id="analysis">
                    ...
                    <div className="text-gray-700 font-sans text-[16px] leading-relaxed space-y-4">
                        <p>
                            It is one of the best solutions for distance hunting of class 1 animals. Fantastic magazine with 10 rounds provides significant ease of use.
                        </p>
                        <p>
                            The only weapon that (technically) is even better is the <a href="#" className="text-green-800 hover:underline">Andersson pistol</a> (<a href="#" className="text-green-800 hover:underline">Weapon Pack 3</a>), which has absolutely identical characteristics but weighs less. The difference between them is that the Virant can be equipped with all of the standard rifle scopes.
                        </p>
                    </div>
                </div>
                ...
                <div id="trivia">
                    ...
                    <p className="text-gray-700 font-sans text-[16px]">
                        The Virant .22LR is modeled after its real-life counterpart of the Marlin Model 795.
                    </p>
                </div>
