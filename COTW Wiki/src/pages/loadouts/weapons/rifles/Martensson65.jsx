      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-72 ml-6 mb-4 bg-white border border-gray-200 shadow-xl font-sans">
                ...
                <div className="p-4 flex justify-center bg-gray-50 relative min-h-[160px] items-center">
                    <img 
                        ...
                        onError={(e) => {e.target.src = "https://static.wikia.nocookie.net/thehuntercotw/images/9/90/Rifle_Martensson_6.5mm.png"}} 
                    />
                </div>
                ...
                <div className="text-sm bg-white">
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
                        ...
                        <div className="text-gray-900">10000</div>
                    </div>
                ...
                <div className="text-sm bg-white">
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
                        ...
                        <div className="text-gray-900">70</div>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2 bg-gray-50">
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2 bg-gray-50">
                        ...
                        <div className="text-gray-900">67</div>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
            ...
            <div className="mb-8 text-gray-700 font-sans text-[16px] leading-relaxed space-y-4">
                <p>
                    The <strong className="text-gray-900">Mårtensson 6.5mm Thunder</strong> is a bolt-action rifle with high accuracy and a generous magazine. Sharing the same role as the .30-06 weapons, this rifle finds itself at home whether you're baiting <a href="#" className="text-green-800 hover:underline">Fallow Deer</a>, or tracking <a href="#" className="text-green-800 hover:underline">Moose</a>. The increased range on the 6.5mm rounds make it an excellent choice for those looking to utilize hunting stands.
                </p>
                <p>
                    This weapon is available as part of the <a href="#" className="text-green-800 hover:underline">Cuatro Colinas Game Reserve</a> DLC.
                </p>
            </div>
            ...
            <div className="mb-8 inline-block bg-gray-50 border border-gray-200 p-2 min-w-[200px]">
                ...
                {isTocOpen && (
                    <ol className="list-decimal list-inside text-gray-700 text-sm space-y-1 font-sans">
                        ...
                        <li><a href="#comparison" className="hover:text-green-600 hover:underline">Comparison to other rifles</a></li>
                    </ol>
                )}
            </div>
            ...
            <div className="space-y-12 clear-both">
                ...
                <div id="sights">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">The following sights can be equipped on the Mårtensson 6.5mm:</p>
                ...
                <div id="variants">
                    ...
                    <div className="text-gray-700 font-sans text-[16px] leading-relaxed space-y-4">
                        <p>
                            <strong className="text-gray-900">Mårtensson 6.5mm Lightning</strong> is a variant that swaps out the olive green polymer body with a white polymer body.
                        </p>
                        <p>
                            <strong className="text-gray-900">Mårtensson 6.5mm Rayo</strong> is a special variant which replaces the polymer body with a dark stained wood body with intricate engravings on the grips. This variant is unlocked by completing all additional quests of Don Miguel Del Bosque.
                        </p>
                        <p>
                ...
                <div id="analysis">
                    ...
                    <div className="text-gray-700 font-sans text-[16px] leading-relaxed space-y-4">
                        <p>
                            The Mårtensson is a great rifle for medium game but struggles a bit with animals on the high end of its performance spectrum (class 8) such as Moose. It is comparable in power to the <a href="#" className="text-green-800 hover:underline">.270 Huntsman</a>, with slightly higher penetration on its Polymer-Tip ammunition. It is one of 5 ingame weapons with the highest effective range of 200m (the other four being the <a href="#" className="text-green-800 hover:underline">Vallgarda .375</a>, <a href="#" className="text-green-800 hover:underline">Gandhare Rifle</a>, the <a href="#" className="text-green-800 hover:underline">Hudzik .50 Caplock</a> Muzzleloader with its .50 Caliber Minié Ball ammunition and the <a href="#" className="text-green-800 hover:underline">Curman .50 Inline</a> Muzzleloader).
                        </p>
                    </div>
                </div>
                ...
                <div id="trivia">
                    ...
                    <p className="text-gray-700 font-sans text-[16px]">
                        The Mårtensson 6.5mm is modeled after its real-life counterpart of the Bergara B-14 HMR.
                    </p>
                </div>
