...
export default function App() {
    ...
    // Variants removed — single-image presentation now used.
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-72 ml-6 mb-4 bg-white border border-gray-200 shadow-xl font-sans">
                ...
                <div className="bg-green-800 text-white text-center font-bold py-2 border-b border-green-900 tracking-wide text-lg">
                    Zagan Varminter
                                ...
                                {/* Variants removed: using single static image */}
                ...
                <div className="p-4 flex justify-center bg-gray-50 relative min-h-[160px] items-center">
                    <img 
                        ...
                        onError={(e) => {e.target.src = "https://static.wikia.nocookie.net/thehuntercotw/images/3/36/Rifle_Zagan_Varminter.png"}} 
                    />
                </div>
            ...
            <div className="mb-8 text-gray-700 font-sans text-[16px] leading-relaxed">
                <p>
                    The <strong className="text-gray-900">Zagan Varminter .22-250</strong> is a rifle that is useful for hunting small game.
                </p>
                <p className="mt-4">
                    This weapon is available as part of the <a href="#" className="text-green-800 hover:underline">Emerald Coast</a> DLC.
                </p>
            </div>
            ...
            <div className="space-y-12 clear-both">
                ...
                <div id="ammo">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">The Zagan Varminter uses .22-250 ammunition:</p>
                ...
                <div id="sights">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">The following sights can be equipped on the Zagan Varminter .22-250:</p>
                ...
                <div id="trivia">
                    ...
                    <p className="text-gray-700 font-sans text-[16px]">
                        The Zagan Varminter is modeled after its real-life counterpart of the Tikka T3x Super Varmint.
                    </p>
                </div>
