    ...
    <div className="min-h-screen text-gray-900 p-6 md:p-12 font-sans tracking-tight bg-white">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-80 ml-6 mb-4 bg-white border border-gray-300 shadow-md font-sans">
                {/* Infobox Title */}
                ...
                <div className="text-sm bg-white">
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2 bg-gray-50">
                        ...
                        <div className="text-gray-900">4.0</div>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
                ...
                <div className="text-sm bg-white">
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
                     ...
                     <div className="grid grid-cols-2 border-b border-gray-200 p-2 bg-gray-50">
                        ...
                        <div className="text-gray-900">65 lb</div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 text-gray-800 font-sans text-[16px] leading-relaxed">
                <p>
                    The <strong className="text-gray-900">Koter CB-65 Orpheus</strong> is a compound bow with a 65 pound peak draw weight. This puts it in the spot between the <a href="#" className="text-green-800 hover:underline">Bearclaw Lite CB-60</a>, and the <a href="#" className="text-green-800 hover:underline">Hawk Edge CB-70</a> in terms of power. A great rounded bow for those looking for a weapon that can fill any role.
                </p>
                <p className="mt-4">
                    This weapon is available as part of the <a href="#" className="text-green-800 hover:underline">High-Tech Hunting Pack</a> DLC.
                </p>
            </div>
            ...
            <div className="space-y-12 clear-both">
                ...
                <div id="sights">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">
                        The following sights can be equipped on the Koter CB-65 Bow:
                    </p>
                ...
                <div id="variants">
                    ...
                    <div className="text-gray-700 font-sans text-[16px] leading-relaxed space-y-4">
                        <p>
                            The <strong className="text-gray-900">Koter CB-65 Hephaestus</strong> is an alternate style featuring a red body with black bowlimbs.
                        </p>
                    </div>
                </div>
