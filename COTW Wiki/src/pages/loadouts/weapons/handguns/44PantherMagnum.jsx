...
export default function App() {
  ...
  const [activeVariant, setActiveVariant] = useState('Panther');
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-72 ml-6 mb-4 bg-white border border-gray-300 shadow-md font-sans text-sm">
                ...
                <div className="text-sm bg-white text-gray-800">
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
                        ...
                        <div className="text-gray-600">24000</div>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2 bg-gray-50">
                        <div className="font-bold text-gray-700">Weight</div>
                        <div className="text-gray-600">1.5</div>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
                        <div className="font-bold text-gray-700">Score</div>
                        <div className="text-gray-600">1235</div>
                    </div>
                </div>
            ...
            <blockquote className="mb-6 border-l-4 border-green-800 pl-4 italic text-gray-600 font-sans text-sm">
                <p className="mb-2">"Single-action revolver using the .44 magnum cartridges. Crafted out of stainless steel, this weapon features a triple-locking cylinder and single-spring mechanism, offering a lighter trigger pull. A big handgun for big game. The speed of the weapon makes it an excellent life saver in hostile situations."</p>
            ...
            <div className="mb-8 text-gray-800 font-sans text-[16px] leading-relaxed">
                <p>
                    The <strong className="text-gray-900">.44 Panther Magnum</strong> is a revolver built for close-range medium to large game. The lightweight construction allows hunters to carry one for emergencies without over encumbering them. This makes the weapon quite valuable as a backup when your rifle is empty and there is a charging bear.
                </p>
            </div>
            ...
            <div className="mb-8 inline-block bg-gray-50 border border-gray-300 p-2 min-w-[250px]">
                ...
                {isTocOpen && (
                    <ol className="list-decimal list-inside text-green-800 text-sm space-y-1 font-sans">
                        ...
                        <li><a href="#comparison" className="hover:text-green-600 hover:underline">Comparison to other handguns</a></li>
                    </ol>
                )}
            </div>
            ...
            <div className="space-y-12 clear-both">
                ...
                <div id="sights">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">
                        The following sights can be equipped on the .44 Panther Magnum:
                    </p>
                ...
                <div id="trivia">
                    ...
                    <p className="text-gray-700 font-sans text-[16px]">
                        The .44 Panther Magnum is modeled after the Ruger Super Redhawk .44 Revolver.
                    </p>
                </div>
                ...
                <div id="comparison">
                    <div className="flex items-center space-x-2 border-b border-gray-300 pb-2 mb-4">
                        <h2 className="text-2xl font-bold text-gray-900">4. Comparison to other handguns</h2>
                        <a href="#" className="text-green-800"><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></a>
                    </div>
