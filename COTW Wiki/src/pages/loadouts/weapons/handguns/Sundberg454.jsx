      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="block">
            ...
            <div className="float-right w-72 ml-6 mb-4 bg-white border border-gray-200 shadow-xl font-sans">
                ...
                <div className="text-sm bg-white">
                    ...
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2 bg-gray-50">
                        ...
                        <div className="text-green-800">2.0</div>
                    </div>
                    <div className="grid grid-cols-2 border-b border-gray-200 p-2">
            ...
            <div className="mb-8 text-gray-700 font-sans text-[16px] leading-relaxed">
                <p>
                    The <strong className="text-gray-900">Sundberg 454</strong> is the most powerful pistol in the game, firing the .454 Casull cartridge. Due to its high power it is suitable for close-range hunting of big game such as <a href="#" className="text-green-800 hover:underline">Bison</a> and <a href="#" className="text-green-800 hover:underline">Moose</a>. This incredible power comes at the cost of lower accuracy, and high recoil. The pistol was added for free for all players with the "theHunter: Call of the Wild’s fifth anniversary" update. It is basically a free <a href="#" className="text-green-800 hover:underline">Rhino 454</a>.
                </p>
            </div>
            ...
            <div className="space-y-12 clear-both">
                ...
                <div id="sights">
                    ...
                    <p className="text-gray-700 text-[16px] mb-4">
                        The following sights can be equipped on the Sundberg 454:
                    </p>
                ...
                <div id="trivia">
                    ...
                    <p className="text-gray-700 font-sans text-[16px]">
                        The Sundberg 454 is modeled after its real-life counterpart of a highly customized and elaborate Taurus Raging Bull.
                    </p>
                </div>
                ...
                <div id="gallery">
                    ...
                    <div className="grid grid-cols-4 gap-x-4 gap-y-[20px]">
                        {[
                ...
                <div id="comparison">
                    <div className="flex items-center space-x-2 border-b border-green-800/50 pb-2 mb-4">
                        <h2 className="text-2xl font-bold text-green-800">5. Comparison to other handguns</h2>
                        <a href="#" className="text-green-800"><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></a>
                    </div>
