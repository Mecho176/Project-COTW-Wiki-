      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Manitoban Elk</div>
            <div style={styles.sidebarImage}>
              <img src={ManitobanElkMain} alt="Manitoban Elk" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              230kg — 450kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>507lbs — 992lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Manitoban Elk</strong> is a <span style={styles.link}>class 7</span> deer that can only be hunted on <span style={styles.link}>Askiy Ridge Hunting Preserve</span>.
            </p>
