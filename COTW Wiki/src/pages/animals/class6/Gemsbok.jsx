      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Gemsbok</div>
            <div style={styles.sidebarImage}>
              <img src={GemsbokMain} alt="Gemsbok" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              100kg — 240kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>220lbs — 529lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Gemsbok</strong> is a <span style={styles.link}>class 6</span> antelope. It can be hunted in the <span style={styles.link}>Vurhonga Savanna Reserve</span>.
            </p>
