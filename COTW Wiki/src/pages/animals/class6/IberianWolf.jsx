...
const IberianWolf = () => {
  ...
  const styles = {
    ...
    rarityQuest: { color: '#000', fontWeight: 'bold', textShadow: '0px 0px 1px #fff' }, // Custom style for Quest items if needed
  };
      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Iberian Wolf</div>
            ...
            <div style={styles.sidebarSection}>
              ...
              30kg — 50kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>66lbs — 110lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Iberian Wolf</strong> is a <span style={styles.link}>class 6</span> predator. It can be hunted in the <span style={styles.link}>Cuatro Colinas Game Reserve</span>. It is the second gray wolf subspecies in the game. It is smaller than the <span style={styles.link}>Gray Wolf</span> in Yukon Valley.
            </p>
            ...
            <div style={{display:'inline-block'}}>
                <table style={{...styles.table, width: '300px'}}>
                    <thead>
                        <tr><th colSpan="2" style={{...styles.th, textAlign: 'center'}}>Cuatro Colinas</th></tr>
                        <tr>
                ...
                <table style={styles.table}>
                    <thead>
                        <tr>
                            ...
                            <th style={{...styles.th, fontWeight:'bold'}}>Quest</th>
                        </tr>
                    </thead>
                    <tbody>
