      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Woodland Caribou</div>
            <div style={styles.sidebarImage}>
              <img src={WoodlandCaribouMain} alt="Woodland Caribou" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              200kg — 419kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>441lbs — 924lbs</span>
            </div>
