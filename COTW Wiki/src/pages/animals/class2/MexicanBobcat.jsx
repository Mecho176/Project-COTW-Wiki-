      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Mexican Bobcat</div>
            <div style={styles.sidebarImage}>
              <img src={MexicanBobcatMain} alt="Mexican Bobcat" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              3kg — 18kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>7lbs — 40lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Mexican Bobcat</strong> is a huntable animal in the reserve <span style={styles.link}>Rancho del Arroyo</span>, located in Mexico. It is the second lynx species to be featured in the game, after the <span style={styles.link}>Eurasian Lynx</span>. In-game, the Mexican Bobcat is identical on all aspects to the <span style={styles.link}>Bobcat</span> in the <span style={styles.link}>New England Mountains</span>.
            </p>
            ...
            <div style={{
              ...
              <ol style={{margin:'0', paddingLeft: '20px', color: '#6fb2e6'}}>
                ...
                <li><a href="#need-zones" style={styles.link} onClick={scrollToId('need-zones')}>Need Zones Times</a></li>
