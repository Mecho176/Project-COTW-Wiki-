      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>European Bison</div>
            <div style={styles.sidebarImage}>
              <img src={EuroBisonMain} alt="European Bison" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              300kg — 920kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>661lbs — 2028lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>European Bison</strong> also called Wisent, is a <span style={styles.link}>class 9</span> animal. It can be hunted in the <span style={styles.link}>Hirschfelden Hunting Reserve</span>. The European Bison is one of three species of bison in the game, the other ones being the <span style={styles.link}>Plains Bison</span> and <span style={styles.link}>Wood Bison</span>.
            </p>
