      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Water Buffalo</div>
            <div style={styles.sidebarImage}>
              <img src={WaterBuffaloMain} alt="Water Buffalo" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              ? — 1250kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>? — 2756lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Water Buffalo</strong> is a <span style={styles.link}>class 9</span> bovine. It can be hunted in <span style={styles.link}>Parque Fernando</span> and <span style={styles.link}>Sundarpatan</span>. Was remodeled in June 2024 and now has a more detailed look. Water Buffalo is one of two species of buffalo in the game, the other one being the <span style={styles.link}>Cape Buffalo</span>.
            </p>
                ...
                {needZonesData.map((reserve, index) => (
                    <div key={index} style={{flex: '1 1 300px', marginBottom: '20px'}}>
                        <table style={{...styles.table, width: '100%'}}>
                            <thead>
                                <tr><th colSpan="2" style={{...styles.th, textAlign: 'center'}}>{reserve.name}{reserve.name === "Sundarpatan" ? "[1]" : ""}</th></tr>
                                <tr>
