      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Puma</div>
            <div style={styles.sidebarImage}>
              <img src={PumaMain} alt="Puma" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              {/* */}
              29kg — 105kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>64lbs — 231lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Puma</strong> is a <span style={styles.link}>class 5</span> feline. It can be hunted in <span style={styles.link}>Parque Fernando</span>. In-game puma is identical in every aspect to <span style={styles.link}>Mountain Lion</span> in <span style={styles.link}>Silver Ridge Peaks</span>.
            </p>
            ...
            <div style={{display:'inline-block'}}>
                <table style={{...styles.table, width: '300px'}}>
                    <thead>
                        <tr><th colSpan="2" style={{...styles.th, textAlign: 'center'}}>Parque Fernando</th></tr>
                        <tr>
