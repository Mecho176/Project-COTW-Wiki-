      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Feral Pig</div>
            <div style={styles.sidebarImage}>
              <img src={FeralPigMain} alt="Feral Pig" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Feral Pig</strong> is a huntable animal in the <span style={styles.link}>Te Awaroa National Park</span> and the <span style={styles.link}>Emerald Coast</span> It is a <span style={styles.link}>class 5</span> animal.
              <br/><br/>
              The Feral Pig is identical in all aspects to the <span style={styles.link}>Wild Hog</span> in the <span style={styles.link}>Mississippi Acres Preserve</span>. It is one of three huntable animals in the game of the species of <em>Sus scrofa</em> (Boar), the other ones being the <span style={styles.link}>Wild Boar</span> and the <span style={styles.link}>Wild Hog</span>.
            </p>
