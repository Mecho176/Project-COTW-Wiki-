      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Collared Peccary</div>
            <div style={styles.sidebarImage}>
              <img src={CollaredPeccaryMain} alt="Collared Peccary" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              14kg — 31kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>31lbs — 68lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Collared Peccary</strong> is a huntable <span style={styles.link}>class 3</span> animal in the <span style={styles.link}>Rancho del Arroyo</span>, also it was backfilled in <span style={styles.link}>Parque Fernando</span> with the Granite Update in December 2022.
            </p>
