      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Axis Deer</div>
            <div style={styles.sidebarImage}>
              <img src={AxisDeerMain} alt="Axis Deer" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              ? — 75kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>? — 165lbs</span>
            </div>
            ...
            <div style={styles.sidebarSection}>
               <div style={{marginBottom:'4px'}}><span style={styles.link}>Parque Fernando</span>, <span style={styles.link}>Emerald Coast</span></div>
            </div>
          </aside>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Axis Deer</strong> is a <span style={styles.link}>class 3</span> deer. It can be hunted on <span style={styles.link}>Parque Fernando</span> and <span style={styles.link}>Emerald Coast</span>.
            </p>
            ...
            <ul style={{fontSize: '0.95rem', paddingLeft: '20px', listStyleType: 'disc', color: '#dbe4eb'}}>
              ...
              <li style={{marginBottom: '8px'}}><a href="https://encyclopedia.pub" style={styles.link} target="_blank" rel="noopener noreferrer">encyclopedia.pub</a></li>
              <li style={{marginBottom: '8px'}}><a href="https://brokenarrowranch.com" style={styles.link} target="_blank" rel="noopener noreferrer">brokenarrowranch.com</a></li>
              <li style={{marginBottom: '8px'}}><a href="https://animalia.bio" style={styles.link} target="_blank" rel="noopener noreferrer">animalia.bio</a> (See attachments)</li>
            </ul>
