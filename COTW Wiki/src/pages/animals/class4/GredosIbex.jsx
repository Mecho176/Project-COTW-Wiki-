      ...
      <div style={styles.innerWrapper}>
        ...
        <div style={styles.layout}>
          ...
          <aside style={styles.sidebarColumn}>
            <div style={styles.sidebarHeader}>Gredos Ibex</div>
            <div style={styles.sidebarImage}>
              <img src={GredosIbexMain} alt="Gredos Ibex" style={{width:'100%', height: '100%', objectFit: 'cover'}} />
            </div>
            ...
            <div style={styles.sidebarSection}>
              ...
              {/* Cited from screenshot 121134/121143 */}
              35kg — 102kg<br/>
              <span style={{color: '#88a0b8', fontSize: '0.85rem'}}>77lbs — 225lbs</span>
            </div>
          ...
          <main style={styles.mainColumn}>
            ...
            <p style={{marginBottom:'20px'}}>
              The <strong>Gredos Ibex</strong> is a <span style={styles.link}>class 4</span> goat. It can be hunted in the <span style={styles.link}>Cuatro Colinas Game Reserve</span>. The Gredos Ibex is one of four types of ibex found in the Cuatro Colinas Game Reserve along the <span style={styles.link}>Ronda Ibex</span>, the <span style={styles.link}>Southeastern Spanish Ibex</span> and the <span style={styles.link}>Beceite Ibex</span>. It is found in the south western quadrant of the reserve.
            </p>
