...
export default function ScentEliminator() {
  const item = consumables.find(c => c.id === 'scent_eliminator');
    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-4 text-gray-700">
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          ...
          <div>
            <strong>Required Level:</strong> {item.level}
          </div>
          <div>
            <strong>DLC:</strong> {item.dlc ? item.dlcName : 'Base Game'}
          </div>
        </div>
      </div>
